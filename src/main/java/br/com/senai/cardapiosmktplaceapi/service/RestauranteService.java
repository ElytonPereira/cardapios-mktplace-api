...
public interface RestauranteService {
	...
	public Page<Restaurante> listarPor(
			...
			@Size(min = 3, max = 250, message = "O nome deve conter entre 3 e 250 caracteries")
			String nome, 
	...
	public Restaurante excluirPor(
			@NotNull(message = "O id para exclução é obrigatório")
			@Positive(message = "O id para exclução deve ser positivo")
			Integer id);
