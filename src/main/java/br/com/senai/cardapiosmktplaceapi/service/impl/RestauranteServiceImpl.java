...
public class RestauranteServiceImpl implements RestauranteService {
	...
	public void atualizarStatusPor(Integer id, Status status) {
		...
		Preconditions.checkNotNull(restauranteEncontrado, "O id não esta vinculado a um restaurante");
		Preconditions.checkArgument(restauranteEncontrado.getStatus() != status, "O status ja esta salvo para o restaurante");
	...
	public Restaurante buscarPor(Integer id) {
		...
		Preconditions.checkArgument(restauranteEncontrado.isAtivo(), "O restaurante esta inativo");
	...
	public Restaurante excluirPor(Integer id) {
		...
		Preconditions.checkArgument(qtdDeCardapiosVinculados == 0, "Existem cardapios vinculados a esse restaurante");
